            ...
            <div class="container-fluid">
                <div class="col-md-6 offset-3 bg-white">
                    ...
                    <form action="{{route('topic#edit',$topic->id)}}" method="POST" class="px-4 py-2">
                        ...
                        <input type="text" name="name" value="{{old('name',$topic->name)}}" class="form-control @error('name') is-invalid @enderror form-control-lg " placeholder="Enter topic...">
                        @error('name')
                        ...
                        <div class="d-flex my-4 justify-content-center">
                            ...
                            <button type="submit" class="btn btn-primary ms-2  "  style="width:75%"><i class="fa-solid fa-arrow-up-from-bracket me-2"></i>Update</button>
                        </div>
                    </form>
                </div>
            </div>
